...
def run(config_dir: str):
    ...
    try:
                        ...
                        for ef_search in config.EF_SEARCHES:
                            ...
                            for qa in qa_data_load:
                                ...
                                if is_multi_question:
                                    ...
                                    new_questions.append(qa.user_prompt)

                                evaluation_content = qa.user_prompt + qa.context
                                try:
                                    for s_v in config.SEARCH_VARIANTS:
                                        ...
                                        if is_multi_question:
                                            (
                                                ...
                                                original_prompt=qa.user_prompt,
                                                output_prompt=qa.output_prompt,
                                                search_type=s_v,
                                                evaluation_content=evaluation_content,
                                                config=config,
                                                evaluator=evaluator,
        ...
        logger.error("The file does not exist: " + config.qa_data_file_path)
