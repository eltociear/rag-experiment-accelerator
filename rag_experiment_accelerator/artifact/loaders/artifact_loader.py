...
from rag_experiment_accelerator.file_handlers.loaders.exceptions import (
    UnsupportedFileFormatException,
)
from rag_experiment_accelerator.file_handlers.loaders.typing import U
...
class ArtifactLoader(Generic[T]):
    ...
    def load_artifacts(self, filename: str, **kwargs) -> list[T] | None:
        ...
        # load artifacts
        content = self.loader.loads(path=path, **kwargs)
